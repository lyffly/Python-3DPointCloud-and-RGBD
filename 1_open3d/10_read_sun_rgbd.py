...
filename_color = 'demodata/RGBD/other_formats/SUN_color.jpg'
filename_depth = 'demodata/RGBD/other_formats/SUN_depth.png'
...
if __name__ == "__main__":
    ...
    rgbd_image = op3.geometry.RGBDImage.create_from_sun_format(
        color_raw,depth_raw
    )
    print(rgbd_image)
    ...
    plot_2_images(rgbd_image.color,rgbd_image.depth,
                "Sun dataset color image","depth image")
